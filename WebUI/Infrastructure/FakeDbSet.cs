...
namespace WebUI.Infrastructure
{
        ...
        where TEntity : class
    {
        ...
        {
            return new FakeTestDbAsyncEnumerator<TEntity>(_data.GetEnumerator());
        }
    }
    ...
    internal class FakeDbAsyncEnumerable<T> : EnumerableQuery<T>, IDbAsyncEnumerable<T>, IQueryable<T>
    {
        ...
        {
            return new FakeTestDbAsyncEnumerator<T>(this.AsEnumerable().GetEnumerator());
        }
    ...
    internal class FakeTestDbAsyncEnumerator<T> : IDbAsyncEnumerator<T>
    {
        private readonly IEnumerator<T> _inner;

        public FakeTestDbAsyncEnumerator(IEnumerator<T> inner)
        {
            _inner = inner;
        }
